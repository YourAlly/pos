...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2022 at 04:30 AM
...
--
-- AUTO_INCREMENT for table `transactions_products`
--
ALTER TABLE `transactions_products`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `transactions_products`
  ADD CONSTRAINT `transactions_products_ibfk_1` FOREIGN KEY (`transact_id`) REFERENCES `transactions` (`id`),
  ADD CONSTRAINT `transactions_products_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`);
COMMIT;
