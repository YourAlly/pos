...
$query = $conn->prepare("SELECT * FROM profiles WHERE user_id = ?;");
$query->execute([$_SESSION['user_id']]);
    ...
    <div class="main-container">
        <div class="profile-container">
            <div class="profilepic-container">
                <h1> My Profile</h1>
                <?php if ($profile['img_url'] != null) { ?>
                    <img src="./img_upload/<?php echo $profile['img_url']; ?>">
                <?php } else { ?>
                    <img src="image/default.jpg">
                <?php } ?>
                <p><a href="./img_upload/">Edit Profile Picture</a></p>
                <p><b>Name</b></p>
                ...
                <p><b><a href="./edit_profile.php">Edit Profile</a></b></p>
            </div>
        </div>
    </div>
